...
function Home() {
  return (
    <>
      <div className=" bg-[#FCFCFC] hidden md:flex gap-10 md1:gap-0 flex-col md:h-[80vh] md:flex-row mt-14 flex-wrap pl-14 relative">
        <div className="flex flex-col gap-5 w-full h-[50%] md1:h-auto md:w-full md1:w-[60%] md:relative  ">
        ...
        <button>  <img className="absolute top-96 left-14" src="/src/assets/Meet Your Therapist.svg" width="200px" height="70px"></img></button>
          <div className=" rounded-lg text-[#717477] font-bold  text-opacity-75 w-48 absolute top-[300px] left-14">Balance Self-care practice and fostering meaningful connections.</div>
            <div className=" flex items-center px-2 gap-2 hover:cursor-pointer  absolute top-5 left-[8.5rem] h-8 font-[600] text-black text-sm  border-gray-600  border-2 border-opacity-5   rounded-3xl">
                <img src="src/assets/icon.svg" width={20} height={20}></img>
               <p>Self Care</p>
                </div>
            <div className="hover:cursor-pointer items-center px-2 gap-2  flex  text-sm  absolute top-5 left-[0.75rem]  h-8 font-semibold border-gray-600  border-2 border-opacity-5  text-black rounded-3xl">
...
<img src="src/assets/icon.svg" width={20} height={20}></img>
 ...
 <img  src="src/assets/message.svg"></img>
        ...
        <div className="md:flex hidden flex-col  gap-14 w-full h-[50%]  md1:h-auto md1:w-[40%] relative">
...
<div className="absolute top-24 pt-2 tracking-tighter  left-[9rem] pl-3 font-semibold text-3xl" >Say Hi To Julie!</div>
        ...
        <img className="md1:absolute hidden  top-32 left-80" src="src/assets/Line.svg"></img>
