      ...
      <div className=" flex flex-col -mt-6  p-10 bg-[#EEF2F3]  rounded-2xl">
        ...
        <div className=" flex justify-between items-center  flex-row">
          ...
          <div className="flex text-sm gap-2 mt-4">
            <button className="  text-center   justify-center inline-flex  items-center w-24 py-2 border-2 border-gray-200 hover:text-white  font-normal hover:border-0 rounded-3xl hover:bg-[#045257] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              More 
            </button>
            <Link to="/Schedule">
            <button className=" text-center  justify-center  inline-flex items-center w-24 px-4 py-2 border-2 border-gray-200 hover:text-white  font-normal hover:border-0 rounded-3xl hover:bg-[#045257] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              Schedule
            </button></Link>
          </div>
        </div>
