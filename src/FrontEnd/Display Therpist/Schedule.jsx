              ...
              <div className="flex gap-10  px-14 py-7 items-center justify-center">
                {selectedDate && (
                  <div className="bg-white rounded-lg flex flex-col gap-3 shadow px-14 py-7 ">
                    ...
                    <div className="flex flex-col ml-4">
                      ...
                      />
                      <button
                        className="bg-teal-700 text-white rounded  hover:bg-teal-600 p-2"
                ...
                <div className="bg-white rounded-lg flex flex-col gap-3 shadow px-14 py-7 mt-4">
                  <h2 className="text-xl font-bold mb-4">
                    Your New Booked Appointments
                  </h2>
                  <div className="grid grid-cols-3 gap-3">
                    {appointments.map((appointment, index) => {
                      const start = dayjs(
                        `2024-01-01T${appointment.startTime}:00`
                      ...
                      return (
                        <div
                          key={index}
                          className="bg-gray-100 text-center flex flex-col w-[7rem] rounded"
                        >
                          <h2 className="text-base font-medium text-orange-500 ">
                            Booked
                          </h2>
                          <p className=" text-xs">
                            {appointment.date.format("MMM D, YYYY")}
                          </p>
                          <p className=" text-xs">
                  ...
                  <p className=" text-xs">
                    Total: {totalHours}hr {totalMinutes}min
                  </p>
