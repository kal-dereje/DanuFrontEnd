...
<input className={`border-b-2 border-[#717477] border-opacity-[0.15] w-[85%] ${!isMatch ? 'border-red-500' : ''}`}  type="password"  value={password} name="password"  onChange={e => setPassword(e.target.value)} placeholder="Password "></input>
<input  className={`border-b-2 border-[#717477] border-opacity-[0.15] w-[85%]  ${!isMatch ? 'border-red-500' : ''}`} type="password"  value={confirmPassword} name="Confirm Password"   onChange={e => setConfirmPassword(e.target.value)}placeholder="Confirm Password "></input>
<div  className="flex flex-col gap-3 items-center ">
<button type="submit"  className="w-[90%] text-white bg-black flex justify-center py-1 rounded-2xl"> <Link to="/verification"></Link>Signup</button>
