...
function VideoChat() {
  ...
  return (
    ...
    <div>
      ...
      <div  className={` flex px-1 md:px-3 rounded-lg gap-1 text-[4px] hover:bg-teal-700 xxsm:text-sm sm:text-xl items-center  bg-${
    ...
    {showNote && ( <div className=" relative rounded-lg bg-gray-300 flex  items-center flex-col gap-2  w-[30%] z-30 h-[28rem] bg-opacity-70">
<p className="bg-[#1E232A] text-gray-300 text-xs w-[90%] my-5 px-2 py-2 rounded" >Your Note about your Client will only be saved when you leave this call after you press the Send Button</p>
<textarea onChange={handleTextAreaChange} className="bg-[#1E232A] text-gray-200 text-xs w-[90%] mb-3 px-2 py-2 h-[80%] rounded" placeholder="Write here">
</textarea>
<button  className="absolute top-[25rem] left-[22rem]  bg-[#1E232A] hover:text-teal-500 text-gray-200 z-40" onClick={handleSendClick}><VscSend size={30}/></button>
...
<button onClick={endCall} className="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded">
<MdOutlineCallEnd size={23}  className="text-black"/>
        </button>
        </div>
        <button   onClick={() => setShowNote(!showNote)} className=" flex justify-end "> 
